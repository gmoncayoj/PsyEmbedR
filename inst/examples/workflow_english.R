# Full PsyEmbedR workflow example in English

library(PsyEmbedR)

items <- c(
  "I recover quickly after a difficult situation.",
  "I can adapt when circumstances change.",
  "My family gives me support when I need it.",
  "People close to me help me deal with problems.",
  "I adjust my behavior when new demands appear.",
  "I can rely on social support during stressful moments."
)

definitions <- c(
  adaptive = "Capacity to adjust flexibly to changes, demands, or adversity.",
  ecological = "Contextual, family, and social resources that support coping."
)
